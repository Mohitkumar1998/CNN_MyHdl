...
def WallaceTreeMultiplier(a, b, mult16, clk):
    ...
    def multiplier_16():
        ...
        carry_stage_2[1] = (partial_products[0][3] and carry_stage_1[1]) or (partial_products[0][3] and sum_stage_1[2]) or (
        ...
        carry_stage_2[9] = (carry_stage_1[16] and sum_stage_1[17]) or (carry_stage_1[16] and partial_products[7][4]) or (
        ...
        mult16.next = intbv(str(int(sl[15])) + "_" + str(int(sl[14])) + "_" + str(int(sl[13])) + "_" + str(int(sl[12])) + "_" + str(
                    int(sl[11])) + "_" + str(int(sl[10])) + "_" + str(int(sl[9])) + "_" + str(int(sl[8])) + "_" + str(int(sl[7])) + "_" + str(int(sl[6])) + "_" + str(int(sl[5])) + "_" + str(int(sl[4])) + "_" + str(
...
def test_multiplier():
    clk = Signal(bool(0))
    a, b = [Signal(intbv(0)[8:]) for i in range(2)]
    mult16 = Signal(intbv(0)[16:])
    ...
    @always(clk.negedge)
    def stimulus():
        a.next = random.randint(0, 255)
        b.next = random.randint(0, 255)
        print(str(int(a)) + " * " + str(int(b)) + " = " + str(int(mult16)))

        assert int(a)*int(b) == int(mult16)
